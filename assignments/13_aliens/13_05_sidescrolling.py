...
class Alien(Sprite):
    def __init__(self, screen):
        ...
        # Random alien color
        alien_color = random.choice([BLUE, PURPLE, YELLOW, RED])
        
        # Draw alien body
        pygame.draw.circle(self.image, alien_color, (size//2, size//2), size//2)
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Sideways Shooter - Enhanced")
    ...
    def _fire_bullet(self):
        ...
        if len(self.bullets) < 8:  # Limit bullets on screen
    ...
    def _check_collisions(self):
        ...
        if collisions:
            ...
            self.aliens_shot += len(collisions)
    ...
    def _update_screen(self):
        ...
        # Draw ship health
        health_text = self.font.render(f"Health: {self.max_ship_hits - self.ship_hits}", True, GREEN)
